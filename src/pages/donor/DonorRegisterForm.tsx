...
import { Activity, ChevronDown, Clock, Sparkles } from "lucide-react"; // Added for icons
    ...
    <>        
      {
        isRegistered ?
          <motion.div 
              ...
              className="bg-white rounded-[2.5rem] p-10 py-30 border border-amber-100 shadow-xl text-center space-y-5 relative overflow-hidden"
            >
              ...
              <div>
                <h2 className="text-2xl font-black text-slate-900 tracking-tight">অনুমোদনের অপেক্ষায়...</h2>
                <p className="text-slate-500 text-sm font-medium mt-2">
                  আপনার আবেদনটি অ্যাডমিনের কাছে পাঠানো হয়েছে। অনুগ্রহ করে অপেক্ষা করুন, আমরা আপনার তথ্য যাচাই করছি।
                </p>
              </div>
              <div className="p-4 bg-slate-50 rounded-2xl flex items-center gap-3 justify-center">
                <Activity size={16} className="text-amber-500" />
                <span className="text-[11px] font-black text-slate-400 uppercase tracking-wider">Status: Under Review</span>
              </div>
          </motion.div> : isUser ?
